...
<body>
  <?php require_once __DIR__ . '/../../../../Projeto/Arquivos/cabecalho.php'; ?>
    ...
    <section class="container_index">
        ...
        <div class="produtos_index">
            <?php hqCardProduto($pdo, 13, ['adicionar' => true, 'classe_preco' => 'preco_index', 'categoria' => 'Sobrenatural']); ?>
            <?php hqCardProduto($pdo, 14, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Sobrenatural']); ?>
            <?php hqCardProduto($pdo, 15, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Sobrenatural']); ?>
            <?php hqCardProduto($pdo, 16, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Sobrenatural']); ?>
        </div>
    </section>
