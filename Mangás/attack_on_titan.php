...
<head>
    ...
    <title>ATTACK ON TITAN | HQ Universe</title>
  ...
  <?php require_once __DIR__ . '/../../../../Projeto/Arquivos/cabecalho.php'; ?>
    ...
    <section class="hero_2">
        <div class="hero-content">
            ...
            <iframe
                ...
                src="https://www.youtube.com/embed/LV-nazLVmgo?si=5ns40IqtS7H7VlC6" title="YouTube video player"
                width="700"></iframe>
        </div>
    </section>
    <!-- PRODUTOS -->
    <section class="container_index">
        ...
        <div class="produtos_index">
            <?php hqCardProduto($pdo, 1, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'AÇÃO']); ?>
            <?php hqCardProduto($pdo, 2, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'AÇÃO']); ?>
            <?php hqCardProduto($pdo, 3, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'AÇÃO']); ?>
            <?php hqCardProduto($pdo, 4, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'AÇÃO']); ?>
        </div>
    </section>
    <!-- Segunda Section-->
    <section class="container_index">
        ...
        <div class="produtos_index">
            <?php hqCardProduto($pdo, 5, ['adicionar' => true, 'classe_preco' => 'preco_index', 'categoria' => 'AÇÃO']); ?>
            <?php hqCardProduto($pdo, 6, ['adicionar' => true, 'classe_preco' => 'preco_index', 'categoria' => 'AÇÃO']); ?>
            <?php hqCardProduto($pdo, 7, ['adicionar' => true, 'classe_preco' => 'preco_index', 'categoria' => 'AÇÃO']); ?>
            <?php hqCardProduto($pdo, 8, ['adicionar' => true, 'classe_preco' => 'preco_index', 'categoria' => 'AÇÃO']); ?>
        </div>
    </section>
