...
<head>
    ...
    <title>Mulher-Maravilha | HQ Universe</title>
  ...
  <?php require_once __DIR__ . '/../../../../Projeto/Arquivos/cabecalho.php'; ?>
    ...
    <section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/bldAkEUANWA?si=YHUrqB8hH0aeOSER" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
    <!-- PRODUTOS -->
    <section class="container_index">
        ...
        <div class="produtos_index">
            <?php hqCardProduto($pdo, 118, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Amazona']); ?>
            <?php hqCardProduto($pdo, 119, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Amazona']); ?>
            <?php hqCardProduto($pdo, 120, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Amazona']); ?>
            <?php hqCardProduto($pdo, 121, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Amazona']); ?>
        </div>
    </section>
