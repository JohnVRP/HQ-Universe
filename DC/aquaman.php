...
<head>
    ...
    <title>AQUAMAN | HQ Universe</title>
...
<section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/90bG43JcwRE?si=xuSSGVri-cMIKZsq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
<!-- PRODUTOS -->
...
<section class="container_index">
    ...
    <div class="produtos_index">
        ...
        <?php hqCardProduto($pdo, 94, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Atlante']); ?>

        <!-- Produto 2 -->

        <?php hqCardProduto($pdo, 95, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Atlante']); ?>

        <!-- Produto 3 -->

        <?php hqCardProduto($pdo, 96, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Atlante']); ?>

        <!-- Produto 4 -->

        <?php hqCardProduto($pdo, 97, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Atlante']); ?>
