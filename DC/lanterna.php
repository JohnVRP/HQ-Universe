...
<head>
    ...
    <title>LANTERNA | HQ Universe</title>
...
<section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/ngEWGqu66jI?si=NIPfX0BbcL2YLIAf" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
<!-- PRODUTOS -->
...
<section class="container_index">
    ...
    <div class="produtos_index">
        ...
        <?php hqCardProduto($pdo, 110, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Herói Cósmico']); ?>

        <!-- Produto 2 -->

        <?php hqCardProduto($pdo, 111, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Herói Cósmico']); ?>

        <!-- Produto 3 -->

        <?php hqCardProduto($pdo, 112, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Herói Cósmico']); ?>

        <!-- Produto 4 -->

        <?php hqCardProduto($pdo, 113, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Herói Cósmico']); ?>
