...
<head>
    ...
    <title>SUPERMAN | HQ Universe</title>
...
<section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/Ox8ZLF6cGM0?si=rXTVvdkfIySX9uOT" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
...
<section class="container_index">
    ...
    <div class="produtos_index">
        ...
        <?php hqCardProduto($pdo, 122, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'DC Comics']); ?>

        <!-- Produto 2 -->

        <?php hqCardProduto($pdo, 123, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'DC Comics']); ?>

        <!-- Produto 3 -->

        <?php hqCardProduto($pdo, 124, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'DC Comics']); ?>

        <!-- Produto 4 -->

        <?php hqCardProduto($pdo, 125, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'DC Comics']); ?>
