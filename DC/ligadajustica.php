...
<head>
    ...
    <title>LIGA DA JUSTIÇA | HQ Universe</title>
...
<section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/BifA90UAQtg?si=dussl_3_MQKJL5kH" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
<!-- PRODUTOS -->
...
<section class="container_index">
    ...
    <div class="produtos_index">
        ...
        <?php hqCardProduto($pdo, 114, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Liga da Justiça']); ?>

        <!-- Produto 2 -->

        <?php hqCardProduto($pdo, 115, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Liga da Justiça']); ?>

        <!-- Produto 3 -->

        <?php hqCardProduto($pdo, 116, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Liga da Justiça']); ?>

        <!-- Produto 4 -->

        <?php hqCardProduto($pdo, 117, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Liga da Justiça']); ?>
