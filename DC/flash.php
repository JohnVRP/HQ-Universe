...
<section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/4A2QyE3KdQ8?si=9Lj83cTqu1vhAQCB" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
<!-- PRODUTOS -->
...
<section class="container_index">
    ...
    <div class="produtos_index">
        ...
        <?php hqCardProduto($pdo, 106, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Liga da Justiça']); ?>

        <!-- Produto 2 -->

        <?php hqCardProduto($pdo, 107, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Liga da Justiça']); ?>

        <!-- Produto 3 -->

        <?php hqCardProduto($pdo, 108, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Liga da Justiça']); ?>

        <!-- Produto 4 -->

        <?php hqCardProduto($pdo, 109, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Liga da Justiça']); ?>
