...
<head>
    ...
    <title>HOMEM-ARANHA | HQ Universe</title>
  ...
  <?php require_once __DIR__ . '/../../../../Projeto/Arquivos/cabecalho.php'; ?>
    ...
    <section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/t06RUxPbp_c?si=gd4kGsmy7QOpilKR" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
    <!-- PRODUTOS -->
    <section class="container_index">
        ...
        <div class="produtos_index">
            <?php hqCardProduto($pdo, 81, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Herói']); ?>
            <?php hqCardProduto($pdo, 82, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Herói']); ?>
            <?php hqCardProduto($pdo, 83, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Herói']); ?>
            <?php hqCardProduto($pdo, 84, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Herói']); ?>
        </div>
    </section>
