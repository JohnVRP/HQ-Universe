...
<head>
    ...
    <title>DOUTOR-ESTRANHO | HQ Universe</title>
  ...
  <?php require_once __DIR__ . '/../../../../Projeto/Arquivos/cabecalho.php'; ?>
    ...
    <section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/oaLko5zhjgY?si=P_RqvK6hDRGAo8H3" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
    <!-- PRODUTOS -->
    <section class="container_index">
        ...
        <div class="produtos_index">
            <?php hqCardProduto($pdo, 69, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Mago Supremo']); ?>
            <?php hqCardProduto($pdo, 70, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Mago Supremo']); ?>
            <?php hqCardProduto($pdo, 71, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Mago Supremo']); ?>
            <?php hqCardProduto($pdo, 72, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Mago Supremo']); ?>
        </div>
    </section>
