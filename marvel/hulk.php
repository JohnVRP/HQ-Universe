  ...
  <?php require_once __DIR__ . '/../../../../Projeto/Arquivos/cabecalho.php'; ?>
    ...
    <section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/e9u0nIKgdDY?si=0V9vY4Vg0-oG2wmW" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
    <!-- PRODUTOS -->
    <section class="container_index">
        ...
        <div class="produtos_index">
            <?php hqCardProduto($pdo, 73, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Força Bruta']); ?>
            <?php hqCardProduto($pdo, 74, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Força Bruta']); ?>
            <?php hqCardProduto($pdo, 75, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Força Bruta']); ?>
            <?php hqCardProduto($pdo, 76, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Força Bruta']); ?>
        </div>
    </section>
