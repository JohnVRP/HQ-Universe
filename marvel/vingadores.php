...
<head>
    ...
    <title>VINGADORES | HQ Universe</title>
  ...
  <?php require_once __DIR__ . '/../../../../Projeto/Arquivos/cabecalho.php'; ?>
    ...
    <section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/LMOqLeoP2yw?si=Knl86j2KM5g1mM-p" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
    <!-- PRODUTOS -->
    <section class="container_index">
        ...
        <div class="produtos_index">
            <?php hqCardProduto($pdo, 89, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Equipe']); ?>
            <?php hqCardProduto($pdo, 90, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Equipe']); ?>
            <?php hqCardProduto($pdo, 91, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Equipe']); ?>
            <?php hqCardProduto($pdo, 92, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Equipe']); ?>
        </div>
    </section>
