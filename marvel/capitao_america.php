...
<head>
    ...
    <title>CAPITÃO AMÉRICA | HQ Universe</title>
  ...
  <?php require_once __DIR__ . '/../../../../Projeto/Arquivos/cabecalho.php'; ?>
    ...
    <section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/t8uUxzKDy-8?si=PD9Zn0zMyZEcO4mB" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
    <!-- PRODUTOS -->
    <section class="container_index">
        ...
        <div class="produtos_index">
            <?php hqCardProduto($pdo, 65, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Vingador']); ?>
            <?php hqCardProduto($pdo, 66, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Vingador']); ?>
            <?php hqCardProduto($pdo, 67, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Vingador']); ?>
            <?php hqCardProduto($pdo, 68, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Vingador']); ?>
        </div>
    </section>
