...
<head>
    ...
    <title>QUARTETO FANTÁSTICO | HQ Universe</title>
  ...
  <?php require_once __DIR__ . '/../../../../Projeto/Arquivos/cabecalho.php'; ?>
    ...
    <section class="hero_2">
        <div class="hero-content">
            ...
            <iframe width="560" height="315" src="https://www.youtube.com/embed/CcSIvhDlYWw?si=hz52A9aCg9iYq0cw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </section>
    <!-- PRODUTOS -->
    <section class="container_index">
        ...
        <div class="produtos_index">
            <?php hqCardProduto($pdo, 200021, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Equipe']); ?>
            <?php hqCardProduto($pdo, 200022, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Equipe']); ?>
            <?php hqCardProduto($pdo, 200023, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Equipe']); ?>
            <?php hqCardProduto($pdo, 200024, ['adicionar' => true, 'classe_preco' => 'preco_index_2', 'categoria' => 'Equipe']); ?>
        </div>
    </section>
